...
<div class="content">
    <div class="side-navigation">
        ...
        <div class="navigation">
            <a href="<?php echo 'edit-project-1.php?idproject='.$id_project;?>" class="active"><div>
    ...
    <form method="POST" action="../../php/edit-project/edit-project-1.php"> 
            <div id="content-side-bar-1" class="content-side-bar" >
                ...
                <input name="projectName" id="edit-project-title" type="text" class="input-link" placeholder="Click Here....." value="<?php echo $rows_edit_p["projectName"]?>"><br><br>
                <label for="" class="bold">Project Description</label><br>
                <textarea name="projectDescription" id="edit-project-description" type="text" class="input-desc" placeholder="Click Here....."><?php echo $rows_edit_p["projectDescription"]?></textarea><br><br> 
