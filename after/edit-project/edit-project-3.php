...
<div class="content">
    <div class="side-navigation">
        <div class="navigation">
            <a href="<?php echo 'edit-project-1.php?idproject='.$id_project;?>" class="inactive inact-hover"><div>
                <label for="" >Project Information</label>
                <img src="../../asset/svg/check.svg"  alt="">
            </div></a>
            <a href="<?php echo 'edit-project-2.php?idproject='.$id_project;?>" class=" inactive inact-hover"><div>
                <label for="">Upload Project</label>
                <img src="../../asset/svg/check.svg" alt="">
            </div></a>
            <a href="<?php echo 'edit-project-3.php?idproject='.$id_project;?>" class="active"><div  >
    ...
    <form method="POST" action="../../php/edit-project/edit-project-3.php" >
                <div id="content-side-bar-3" class="content-side-bar">
                    ...
                    <Input id="inputText" name="projectTag" class="input-link" type="text" placeholder="Click Here....." oninput="createWordBoxes()" value="<?php echo $rows_edit_p["projectTag"]?>"><br><br>
                    <div id="wordContainer"></div>

                    <br>
                    <label for="" class="bold">Project status</label><br>
                    <select name="projectStatus" id="" >
                            <option value="<?php echo $rows_edit_p["projectStatus"]?>" selected><?php echo $rows_edit_p["projectStatus"]?></option>
