...
<html lang="en">
    <head>
        ...
        <title>Profil |
            <?php echo $nama_lengkap["nama_lengkap"]?>
        </title>
                ...
                <div class="navbar-actions">
                    ...
                    <div class="button-dropdown">
                        <div class="button-dropdown-1 margin-auto">
                            <!-- <div class="foto-profil" style="background-image:
                            url('../asset/pp.png');"></div> -->
                            <div
                                class="foto-profil"
                                style="<?php
                    ...
                    ?>"></div>
                        ...
                        <div class="dropdown-content">
                            <a href="profil.php"><div class="List-dropdown dd-act">
            ...
            <div class="profil_2">
                ...
                <div class="profil_desc"><br>
                    ...
                    <div class="profil-desc-button">
                        <a href="edit profil/edit_profil_general.php" class="button_2">Edit Profile</a>
                        <a href=""></a>
                    </div>
                </div>
            </div>
        ...
        <div class="content-profil-about">
            ...
            <div class="content-profil-about-2">
                ...
                <div class=" list-sosmed">
                    ...
                    <?php if ($rows["personalWeb"] != "") {?>
                    <div class="list-sosmed-1">
                        <div class="list-sosmed-1-left">
                            <label class="bold2 ft-20">
                                Personal Web</label>
                        </div>
                        <div class="list-sosmed-1-2">
                            <a href="<?php echo $rows["personalWeb"]?>" target="_blank"><img src="../asset/svg/arrow-up-right.png" alt=""></a>
                        </div>
                    </div>
                    <?php }?>
                    
                    <?php if ($rows["instagram"] != "") {?>
                    <div class="list-sosmed-1">
                        <div class="list-sosmed-1-left">
                            <label class="bold2 ft-20">Instagram</label>
                        </div>
                        <div class="list-sosmed-1-2">
                            <a href="<?php echo $rows["instagram"]?>" target="_blank"><img src="../asset/svg/arrow-up-right.png" alt=""></a>
                        </div>
                    </div>
                    <?php }?>

                    <?php if ($rows["linkedin"] != "") {?>
                    <div class="list-sosmed-1">
                        <div class="list-sosmed-1-left">
                            <label class="bold2 ft-20">
                                LinkedIn</label>
                        ...
                        <div class="list-sosmed-1-2">
                            <a href="<?php echo $rows["linkedin"]?>" target="_blank"><img src="../asset/svg/arrow-up-right.png" alt=""></a>
                        </div>
                    </div>
                    <?php }?>
                    ...
                    <div class="list-sosmed-1">
                        ...
                        <div class="list-sosmed-1-2">
                            <a href="<?php echo $rows["github"]?>" target="_blank"><img src="../asset/svg/arrow-up-right.png" alt=""></a>
                        </div>
                    </div>
                    <?php }?>
                    ...
                    <div class="list-sosmed-1">
                        ...
                        <div class="list-sosmed-1-2">
                            <a href="<?php echo $rows["medium"]?>" target="_blank"><img src="../asset/svg/arrow-up-right.png" alt=""></a>
                        </div>
                    </div>
                    <?php }?>
                    ...
                    <div class="list-sosmed-1">
                        ...
                        <div class="list-sosmed-1-2">
                            <a href="<?php echo $rows["x"]?>" target="_blank"><img src="../asset/svg/arrow-up-right.png" alt=""></a>
                        </div>
                    </div>
                    <?php }?>
