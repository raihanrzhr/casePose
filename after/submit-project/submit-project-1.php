    ...
    <body>
        ...
        <div class="content">
            <div class="side-navigation"> 
                ...
                <a id="back1" href="../index.php" class="button-contained" ><img src="../../asset/chevron-left.png">Back to Home</a>
            </div>
        <!-- form -->
            <form method="POST" action="../../php/submit-project/proses-submit-1.php" id="form1">
                <div class="content-side">
                    <div id="content-side-bar-1" class="content-side-bar">
                        <label for="" class="bold">Project Name</label><br>
                        <input type="text" class="input-link" id="projectName" name="projectName" placeholder="Click Here....."><br><br>
                        <label for="" class="bold">Project Description</label><br>

                        <textarea type="text" class="input-desc" id="projectDescription" name="projectDescription" placeholder="Click Here....."></textarea><br><br>
                        ...
                        <div class="div-footer">
                            <script src="../../javascript/submit.js"></script>
                            <a id="cancel2" class="button-1 bold2" href="../index.php">Cancel</a>
                            <button class="button-2 bold2" type="submit" onclick="">Next</button>
                        </div>
                    </div>
                </div>
            </form>     
