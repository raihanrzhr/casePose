        ...
        <form method="POST" action="../../php/submit-project/proses-submit-1.php" id="form1">
            <div class="content-side">
                <div id="content-side-bar-1" class="content-side-bar">
                    ...
                    <input type="text" class="input-link" id="projectName" name="projectName" placeholder="Type Here....."><br><br>
                    <label for="" class="bold">Project Description</label><br>

                    <textarea type="text" class="input-desc" id="projectDescription" name="projectDescription" placeholder="Type Here....."></textarea><br><br>
                    <script>
