...
$projectLink = $_GET["projectLink"];

$projectLink = $_GET["projectLink"];
$projectPicture = $_GET['projectPicture'];

$projectTag = $_GET["projectTag"];
...
<html lang="en">
    ...
    <body>
        ...
        <nav>
            ...
            <div class="navbar">
                ...
                <div class="navbar-actions">
                    ...
                    <a onclick="notifikasiLogout()" class="navbar-button-logout">
        ...
        <!-- form -->
            <form method="POST" action="../../php/submit-project/proses-submit-4.php">
                <div class="content-side">
                    ...
                    <label for="fileInput" class="bold">Project Picture</label>
                        ...
                        if(isset($_GET['pesan'])){
                            ...
                            else if ($_GET['pesan'] == "project-tag-length-255"){
                                echo "The project tag cannot exceed 255 digits";
                        ...
                        <!-- disembunyikan -->
                        <input type="date" id="date" name="projectDate" value="<?php echo $today; ?>" hidden>
                        <input type="text" value="<?php echo $projectPicture?>" name="projectPicture" hidden>
                        <div class="div-footer">
                            <a id="cancel3" class="button-1 bold2" onclick="notifikasiBack()">Cancel</a>
                            <button id="next1" class="button-2 bold2" type="submit">Upload Project</button>
                        </div>
                    </div>
                </div>
            </form>
