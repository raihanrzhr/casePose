    ...
    <div class="content">
        <div class="side-navigation">
            ...
            <div class="navigation">
                ...
                <a href="edit_profil_general.php" class="active" ><div >General</div></a>
                <a href="edit_profil_password.php" class="inactive" ><div >Password</div></a>
                <a href="edit_profil_social.php" class="inactive"><div >Social Profiles</div></a>

                <div class="inactive">
                    <a href="" style="color: rgba(107, 114, 128, 1);">Billing</a>
        ...
        <div class="container-form">
            <div class="profile-picture">
                    <img src="<?php 
                    if ($rows["profilePicture"] == ""){
                        echo "../../asset/default-profil.jpg";
                    } else {
                        echo "../../asset/".$rows["profilePicture"];
                    }
                    ?>" />
    ...
    <footer class="footer">
        <div class="footer-navigation ">
            ...
            <div class="footer-navigation-button margin-auto">
                <a href="https://instagram.com" class="footer-social-button" target="_blank" rel="noopener"
                ...
                <a href="https://linkedin.com" class="footer-social-button" target="_blank" rel="noopener"
                ...
                <a href="https://twitter.com" class="footer-social-button" target="_blank" rel="noopener"
